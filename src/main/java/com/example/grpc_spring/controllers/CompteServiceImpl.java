package com.example.grpc_spring.controllers;

import com.example.grpc_spring.services.CompteService;
...
public class CompteServiceImpl extends CompteServiceGrpc.CompteServiceImplBase {
     ...
     */
    private Compte convertCompteEntityToGrpc(com.example.grpc_spring.entities.Compte entity) {
    ...
    public void compteById(GetCompteByIdRequest request, StreamObserver<GetCompteByIdResponse> responseObserver) {
        com.example.grpc_spring.entities.Compte entity = compteService.findCompteById(request.getId());
    ...
    public void saveCompte(SaveCompteRequest request, StreamObserver<SaveCompteResponse> responseObserver) {
        ...
        var compteEntity = new com.example.grpc_spring.entities.Compte();
